export const getTypeStyle = (type: string) => {
  ...
  if (t === 'phr' || t.startsWith('phrase') || t.startsWith('phr')) return 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300 border-pink-200 dark:border-pink-800';
